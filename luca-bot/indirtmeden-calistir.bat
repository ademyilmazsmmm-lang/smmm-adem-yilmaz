...
cd /d "%~dp0"
echo ============================================
echo   Luca Bot - Tarayiciya Indirtmeden
echo ============================================
echo.
echo Dosyayi tarayici indirmez; istek yakalanip dosya
echo Python tarafinda kaydedilir. Tarayici indirme aninda
echo cokuyorsa bu yol cokmeyi tamamen atlar.
echo.
...
echo.
if "%firma%"=="" (
  %PY% luca_bot.py --indirmeyi-yakala --baslangic "%bas%" --bitis "%bit%"
) else (
  %PY% luca_bot.py --indirmeyi-yakala --baslangic "%bas%" --bitis "%bit%" --firma "%firma%"
)
echo.
pause
exit /b 0
