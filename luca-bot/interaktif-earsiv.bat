...
cd /d "%~dp0"
echo ============================================
echo   Luca Bot - Interaktif V.D. E-Arsiv Sorgulama
echo ============================================
echo.
echo Isletme Defteri - E-Arsiv Faturalari Sorgulama ekranini kullanir.
echo GIB Servis ile iki kez sorgular, iptal/itiraz bakar, Excel indirir.
echo.
...
echo.
if "%firma%"=="" (
  %PY% luca_bot.py --belge-tipi e-arsiv-interaktif --baslangic "%bas%" --bitis "%bit%"
) else (
  %PY% luca_bot.py --belge-tipi e-arsiv-interaktif --baslangic "%bas%" --bitis "%bit%" --firma "%firma%"
)
echo.
pause
exit /b 0
